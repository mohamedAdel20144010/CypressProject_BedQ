...
describe ('Customer Rate Validation', () => {
    ...
    it.skip('Positive - Verify response while fill all fields and click on submit',()=>{

        ProductDetails.Fill_All_CustomerRate_Fields()
    })

    it.skip('Negative - Verify response while leave Rate section Empty and submit', () => {

        ProductDetails.Leave_Rate_Section_Empty()
    })

    it.skip('Negative - Verify response while leave (Nickname) field empty and submit', ()=>{
        ProductDetails.Leave_UserName_empty()
    })

    it.skip('Negative - Verify response while leave (Summary) field empty and submit',()=>{
